...
from .agent import Agent, Pose, AgentSpawnParams
...
class SimObjectManager:
    ...
    def __init__(self, sim_core=None):
        ...
        self.object_ids: Dict[int, SimObject] = {}  # body_id -> object mapping
    ...
    def spawn_objects_grid(self, num_objects: int,
                          grid_params: GridSpawnParams,
                          spawn_params: SimObjectSpawnParams) -> List[SimObject]:
        """
    ...
    def spawn_grid_mixed(self, num_objects: int,
                        grid_params: GridSpawnParams,
                        spawn_params_list: List[Tuple[SimObjectSpawnParams, float]]) -> List[SimObject]:
        """
    ...
    def _spawn_grid_mixed_impl(self, num_objects: int,
                              grid_params: GridSpawnParams,
                              spawn_params_list: List[Tuple[Any, float]],
                              object_class: type,
                              manager_name: str) -> List[Any]:
        """
            ...
            if current_x > x_max:
                ...
                if current_y > y_max:
                    ...
                    if current_z > z_max:
                        # Grid exhausted
                        if i < num_objects - 1:
                            print(f"[{manager_name}] Warning: Grid exhausted after {i + 1} iterations "
...
class AgentManager(SimObjectManager):
    """
    ...
    def spawn_agents_grid(self, num_agents: int,
                         grid_params: GridSpawnParams, 
    ...
    def spawn_agents_grid_mixed(self, num_agents: int,
                                grid_params: GridSpawnParams,
                                spawn_params_list: List[Tuple[AgentSpawnParams, float]]) -> List[Agent]:
        """
    ...
    def __repr__(self):
        return (f"AgentManager(total={len(self.objects)}, "
