...
<table align="center">
<tr>
<td align="center"><b>100 Robot Grid</b><br><sub>100robots_grid_demo.py</sub><br>
<img src="docs/media/100robots_grid_mixed.gif" width="380" alt="100 Robot Grid"></td>
...
ROS 2 bridge scale checks on 2026-07-25 measured 1000-robot maximum RTF of 9.37x in fleet mode, 0.64x in per-robot mode, and 0.30x in hybrid mode. Per-robot topic publication completed in 0.217 s, but motion verification reached 0/1000 within 60 s; see [`ros2_bridge/PERFORMANCE.md`](ros2_bridge/PERFORMANCE.md).
