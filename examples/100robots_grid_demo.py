...
from pybullet_fleet.agent import Agent, Pose, AgentSpawnParams
...
mobile_robot_prob = mixed_mode_config.get('mobile_robot_prob', 0.6)
arm_robot_prob = mixed_mode_config.get('arm_robot_prob', 0.4)
...
mobile_params = AgentSpawnParams(
    ...
    max_vel=mobile_robot_config.get('max_vel', 2.0),
    max_accel=mobile_robot_config.get('max_accel', 5.0),
...
if mode == 'mixed':
    ...
    arm_params = AgentSpawnParams(
        ...
        max_vel=arm_robot_config.get('max_vel', 0.0),
        max_accel=arm_robot_config.get('max_accel', 0.0),
    ...
    spawn_params_list = [
        (mobile_params, mobile_robot_prob),
        (arm_params, arm_robot_prob)
    ]
