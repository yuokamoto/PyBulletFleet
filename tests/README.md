...
- 1台のロボットが正方形パスを辿る
- `pybullet_fleet/examples/mobile/path_following_demo.py`で代替可能
- デバッグや比較用に保存
...
- コールバックを使った更新ロジック
- `pybullet_fleet/examples/mobile/path_following_demo.py`のベースとなった実験ファイル
- デバッグ出力が豊富
...
3. **本格的なデモ**: `pybullet_fleet/examples/mobile/path_following_demo.py`を使用

---

## 参考

- メインのデモは`pybullet_fleet/examples/`ディレクトリにあります
- `pybullet_fleet/examples/mobile/path_following_demo.py`: Omnidirectional vs Differential driveの比較デモ
- `pybullet_fleet/examples/scale/100robots_grid_demo.py`: 100台のロボットのグリッドデモ
